...
git clone <https://github.com/hyperpolymath/KnotTheory.jl.git> cd
KnotTheory.jl
...
toolbox create KnotTheory.jl-dev toolbox enter KnotTheory.jl-dev \#
...
KnotTheory.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/KnotTheory.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/KnotTheory.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/KnotTheory.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/KnotTheory.jl/labels/perimeter-3) — Community sandbox scope
