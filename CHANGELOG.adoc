...
* `+GaussCode+` type for signed Gauss code representation of oriented
knot diagrams
* Conversion API: `+to_pd+`, `+to_dt+`, `+from_dt+`, `+to_gauss+`,
`+from_gauss+`
* Round-trip test coverage for PD↔DT, PD↔Gauss, and braid-word
conversions
...
* License migration: AGPL-3.0 → MPL-2.0 (source) / MPL-2.0 (LICENSE
file)
