...
7. `/var$REPOS_DIR/KnotTheory.jl/ABI-FFI-README.md` -- `{{PROJECT}}`, `{{project}}`, `PMPL-1.0-or-later`
8. `/var$REPOS_DIR/KnotTheory.jl/SECURITY.md` -- `hyperpolymath`, `KnotTheory.jl`, `6759885+hyperpolymath@users.noreply.github.com`, `[PGP fingerprint not set]`, `{{PGP_KEY_URL}}`, `{{WEBSITE}}`, `2026`, `KnotTheory.Jl`
9. `/var$REPOS_DIR/KnotTheory.jl/CODE_OF_CONDUCT.md` -- `KnotTheory.Jl`, `hyperpolymath`, `KnotTheory.jl`, `{{CONDUCT_EMAIL}}`, `{{CONDUCT_TEAM}}`, `{{RESPONSE_TIME}}`, `2026`, `github.com`
10. `/var$REPOS_DIR/KnotTheory.jl/CONTRIBUTING.md` -- `github.com`, `hyperpolymath`, `KnotTheory.jl`, `main`
