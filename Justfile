...
doctor:
    @echo "Running diagnostics for KnotTheory.jl..."
...
help-me:
    @echo "=== KnotTheory.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/KnotTheory.jl/issues/new"
    @echo ""
