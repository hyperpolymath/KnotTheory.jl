...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/KnotTheory.jl/security/advisories/new)
...
- This repository (`hyperpolymath/KnotTheory.jl`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/KnotTheory.jl/security/advisories)
