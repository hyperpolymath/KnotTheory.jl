...
[[knottheoryjl-development-roadmap]]
...
[[v010--v020-roadmap-near-term]]
=== v0.1.0 → v0.2.0 Roadmap (Near-term)

[[v11---core-invariants--performance-3-6-months]]
...
* [ ] *Knot table integration* - Import Rolfsen, HTW tables (10K{plus} knots up to 16 crossings)
...
[[v12---advanced-topology--integration-6-12-months]]
...
[[v13-roadmap-speculative]]
=== v1.3{plus} Roadmap (Speculative)
...
* *Knot foundation model* - Pre-trained on all known knots (100K{plus} diagrams)
...
* *Global knot census* - Distributed computation of all knots up to 20{plus} crossings

'''''

[[future-horizons-v20]]
=== Future Horizons (v2.0{plus})
...
*v1.2 → v1.3{plus}:* Breaking changes likely (higher-dimensional topology needs fundamental redesign)
...
Item 11 .md/.adoc consolidation (Day 10 lossy-tail). 44 legacy-only
